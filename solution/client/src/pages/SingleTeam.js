...
export default function SingleTeam() {
  ...
  return (
      ...
      <div>
        <div id="container-single-team overall-info-container" className="container-background-color">
          <TopAppBar links={links} />
          <div>
            <div id="title-box">
              <img
            ...
            <div className="team-infos single-team-card" style={{color: 'white'}}>
              <p>
                <strong>Competition:</strong>{' '}
                <a
                    style={{color: 'white'}}
                    href={`/single-competition/${team.domesticCompetitionId}`}
                    target="_blank"
              ...
              <p>
                ...
                {team ? team.squadSize : 'Loading...'}
              </p>
              <p>
                <strong>Average age:</strong>{' '}
                {team ? team.averageAge : 'Loading...'}
              </p>
              <p>
                <strong>National Teams Players:</strong>{' '}
                {team ? team.nationalTeamPlayers : 'Loading...'}
              </p>
              <p>
                <strong>Foreign Players:</strong>{' '}
                {team ? team.foreignersNumber : 'Loading...'}
              </p>
              <p>
                <strong>Foreigners Percentage:</strong>{' '}
                {team ? team.foreignersPercentage : 'Loading...'}
              </p>
              <p>
              ...
              <p>
                <strong>Last Season played:</strong>{' '}
                {team ? team.lastSeason : 'Loading...'}
              </p>
              <p>
          ...
          <div id="middle-container-team">
            ...
            {view === 0 ? (
                ...
                <div className="placeholder">{/* Remove this  */}</div>
            )}
          </div>
          <ArrowBack />
          <ChatIcon />
